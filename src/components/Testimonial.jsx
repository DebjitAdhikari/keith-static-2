                ...
                <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                  <div>
                    ...
                    <div className="mt-4">
                      ...
                      Keith Ceramic has truly transformed my space! The quality and attention to detail in every piece are unmatched. Highly recommend to anyone looking for timeless ceramic artistry.
                      </p>
                    </div>
                  </div>
                  <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">&mdash; Ravi Kumar</footer>
                </blockquote>
              </div>
              ...
              <div className="keen-slider__slide">
                <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                  <div>
                    ...
                    <div className="mt-4">
                      <p className="text-2xl font-bold text-[#02245B] sm:text-3xl">Loyality</p>
                      <p className="mt-4 leading-relaxed text-gray-700">
                      I’ve been a loyal customer of Keith Ceramic for years. Their products consistently exceed my expectations, and the craftsmanship is always top-notch. A company I trust!
                      </p>
                    </div>
                  </div>
                  <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">&mdash; Anjali Patel</footer>
                </blockquote>
              </div>
              ...
              <div className="keen-slider__slide">
                <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                  <div>
                    ...
                    <div className="mt-4">
                      <p className="text-2xl font-bold text-[#02245B] sm:text-3xl">Amazing</p>
                      <p className="mt-4 leading-relaxed text-gray-700">
                      The ceramic pieces I purchased from Keith Ceramic are absolutely stunning. Not only are they beautifully crafted, but they also add an elegant touch to any room. Exceptional work!
                      </p>
                    </div>
                  </div>
                  <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">&mdash; Vikram Singh</footer>
                </blockquote>
              </div>
